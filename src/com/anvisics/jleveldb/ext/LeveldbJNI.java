...
class LeveldbJNI {
  ...
  public final static native void Options_create_if_missing_set(long jarg1, Options jarg1_, boolean jarg2);
  public final static native boolean Options_create_if_missing_get(long jarg1, Options jarg1_);
  public final static native void Options_error_if_exists_set(long jarg1, Options jarg1_, boolean jarg2);
  public final static native boolean Options_error_if_exists_get(long jarg1, Options jarg1_);
  public final static native void Options_paranoid_checks_set(long jarg1, Options jarg1_, boolean jarg2);
  public final static native boolean Options_paranoid_checks_get(long jarg1, Options jarg1_);
  public final static native void Options_write_buffer_size_set(long jarg1, Options jarg1_, long jarg2);
  public final static native long Options_write_buffer_size_get(long jarg1, Options jarg1_);
  public final static native void Options_max_open_files_set(long jarg1, Options jarg1_, int jarg2);
  public final static native int Options_max_open_files_get(long jarg1, Options jarg1_);
  public final static native void Options_block_size_set(long jarg1, Options jarg1_, long jarg2);
  public final static native long Options_block_size_get(long jarg1, Options jarg1_);
  public final static native void Options_block_restart_interval_set(long jarg1, Options jarg1_, int jarg2);
  public final static native int Options_block_restart_interval_get(long jarg1, Options jarg1_);
  ...
  public final static native void ReadOptions_verify_checksums_set(long jarg1, ReadOptions jarg1_, boolean jarg2);
  public final static native boolean ReadOptions_verify_checksums_get(long jarg1, ReadOptions jarg1_);
  public final static native void ReadOptions_fill_cache_set(long jarg1, ReadOptions jarg1_, boolean jarg2);
  public final static native boolean ReadOptions_fill_cache_get(long jarg1, ReadOptions jarg1_);
